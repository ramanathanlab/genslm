...
from genslm.config import throughput_config
...
from genslm.utils import PerplexityCallback
from genslm.utils import SequenceGenerationCallback
from genslm.utils import ThroughputMonitor
...
def train(cfg: ModelSettings) -> None:  # noqa
    ...
    if cfg.deepspeed_flops_profile:
        ...
        max_steps = cfg.max_steps  # disable, see https://pytorch-lightning.readthedocs.io/en/stable/common/trainer.html#max-steps
